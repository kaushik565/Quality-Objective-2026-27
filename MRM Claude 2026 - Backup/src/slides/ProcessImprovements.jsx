          ...
          <table style={{ width:'100%', borderCollapse:'collapse', tableLayout:'fixed' }}>
            <thead>
              <tr>
                ...
                <th style={th({ background:'#374151', color:'#fff', width:'24%' })}>Improvements Done</th>
                <th style={th({ background:'#374151', color:'#fff', width:'24%' })}>In Progress</th>
                <th style={th({ background:'#374151', color:'#fff', width:'24%' })}>Planned</th>
              </tr>
            </thead>
            <tbody>
              {SITES.map((site, i) => (
              ...
              <tr style={{ background:'#f3f4f6', borderTop:'2px solid #d1d5db' }}>
                <td style={td({ textAlign:'left', fontWeight:900, color:'#111111', fontSize:15 })}>TOTAL</td>
                <td style={td({ color:'#CC0000', fontWeight:900, fontSize:22 })}>—</td>
                <td style={td({ color:'#374151', fontWeight:900, fontSize:22 })}>—</td>
        ...
        <div style={{ flex:1, minHeight:0, border:'1px solid #e5e7eb', borderRadius:4, overflow:'hidden' }}>
          ...
          <table style={{ width:'100%', borderCollapse:'collapse', tableLayout:'fixed' }}>
            <thead>
              <tr>
                <th style={th({ background:'#1f2937', color:'#fff', textAlign:'left', width:'28%' })}>Site</th>
                <th style={th({ background:'#7F1D1D', color:'#fff', width:'36%' })}>Regular Activity Meetings</th>
                <th style={th({ background:'#CC0000', color:'#fff', width:'36%' })}>Improvement Meetings</th>
              </tr>
            </thead>
            <tbody>
              {SITES.map((site, i) => (
