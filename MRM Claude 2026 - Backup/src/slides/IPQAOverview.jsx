...
const C = '#CC0000'
const SITES = [
  { site:'Site-I', color:'#CC0000' }, { site:'Site-III', color:'#7F1D1D' },
  { site:'Site-IV', color:'#374151' }, { site:'Site-V', color:'#111827' },
]
            ...
            <div key={site} style={{ border:'1px solid #e5e7eb', borderTop:`3px solid ${color}`,
              ...
              {['Clearance','Closure','Incidents'].map(k=>(
                <div key={k} style={{ display:'flex', justifyContent:'space-between', marginBottom:6 }}>
                  ...
                  <span style={{ color:'#111111', fontWeight:800, fontSize:16 }}>—</span>
                </div>
              ))}
            </div>
          ))}
