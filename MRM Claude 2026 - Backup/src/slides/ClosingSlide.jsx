export default function ClosingSlide() {
  return (
    <section style={{
      width:'100%', height:'100vh', overflow:'hidden', background:'#111111',
      ...
      <div style={{ flex:1, display:'flex' }}>
        {/* Left panel */}
        <div style={{ width:'40%', background:'#CC0000', display:'flex', flexDirection:'column',
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column',
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:12, marginBottom:40 }}>
            {[['Site-I','#CC0000'],['Site-III','#7F1D1D'],['Site-IV','#374151'],['Site-V','#111827']].map(([s,c])=>(
